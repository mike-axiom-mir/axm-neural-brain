...
Implementation update, 2026-09-25: a bounded slice now runs in the
[Neural Innovation Laboratory](../INNOVATION_LAB.md): isolated configuration
mutations, evidence archives and a learned selector over known operators. The
complete architecture below, including open-ended invention, remains a research
direction. The laboratory's measured claim and limits are narrower than this map.
